...
class OLED {
   ...
   public:
    ...
    void OLED_GDDRAM_Refresh(u8 leftPixel = 0, u8 topPixel = 0, u8 rightPixel = 128, u8 bottomPixel = 64);
    ...
    // 这个函数用于画有边框的填充矩形;
    void fillrectangle(u8 leftPixel, u8 topPixel, u8 rightPixel, u8 bottomPixel);

    // 这个函数用于清空矩形区域;
    void clearrectangle(u8 leftPixel, u8 topPixel, u8 rightPixel, u8 bottomPixel);

    // 设置文本框(文本框左部 x 坐标, 文本框顶部 y 坐标, 文本框右部 x 坐标,文本框底部 y 坐标);
    void setTextBox(u8 leftPixel, u8 topPixel, u8 rightPixel, u8 bottomPixel);
